   ...
   <div class="acc-f">
    <ul class="acc-list">
      ...
      <li>
        ...
        <div class="f-input">
          <input type="text" class="com-input input-dis input320" disabled="true" placeholder="请输入文档名称" v-model="doc.title" />
        </div>
      </li>
      <li>
  ...
  export default {
    ...
    methods: {
      ...
      submitinfo:function(){
        ...
        this.$http.get($API.supplier.categorymodifydoc.url,this.doc).then(
